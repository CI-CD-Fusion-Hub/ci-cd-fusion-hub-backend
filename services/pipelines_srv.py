...
class PipelinesService:
    ...
    async def get_all_pipelines(self, request: Request) -> JSONResponse:
        user_access_level = request.session.get(SessionAttributes.USER_ACCESS_LEVEL.value)
        user_pipelines = request.session.get(SessionAttributes.USER_PIPELINES.value)
    ...
    async def get_pipeline_by_id(self, request: Request, pipeline_id: int) -> JSONResponse:
    ...
    async def get_all_gitlab_pipelines(self, request: Request) -> JSONResponse:
        user_access_level = request.session.get(SessionAttributes.USER_ACCESS_LEVEL.value)
        user_pipelines = request.session.get(SessionAttributes.USER_PIPELINES.value)
    ...
    async def get_gitlab_pipeline_builds(self, request: Request, pipeline_id: int) -> JSONResponse:
        await self._validate_user_access(request, pipeline_id)
    ...
    async def get_gitlab_pipeline_build(self, request: Request, pipeline_id: int, build_id: int) -> JSONResponse:
        await self._validate_user_access(request, pipeline_id)
    ...
    async def get_gitlab_pipeline_build_jobs(self, request: Request, pipeline_id: int, build_id: int) -> JSONResponse:
        await self._validate_user_access(request, pipeline_id)
    ...
    async def get_gitlab_pipeline_build_job_trace(self, request: Request,
                                                  pipeline_id: int, build_id: int, job_id: int) -> JSONResponse:
        await self._validate_user_access(request, pipeline_id)
    ...
    async def run_new_gitlab_pipeline_build(self, request: Request,
                                            pipeline_id: int, params: GitlabStartPipelineParams) -> JSONResponse:
        await self._validate_user_access(request, pipeline_id)
    ...
    async def retry_gitlab_pipeline_build(self, request: Request, pipeline_id: int, build_id: int) -> JSONResponse:
        await self._validate_user_access(request, pipeline_id)
    ...
    async def cancel_gitlab_pipeline_build(self, request: Request, pipeline_id: int, build_id: int) -> JSONResponse:
        await self._validate_user_access(request, pipeline_id)
    ...
    async def get_gitlab_pipeline_params(self, request: Request, pipeline_id: int) -> JSONResponse:
        await self._validate_user_access(request, pipeline_id)
    ...
    async def get_all_jenkins_pipelines(self, request: Request) -> JSONResponse:
        user_access_level = request.session.get(SessionAttributes.USER_ACCESS_LEVEL.value)
        user_pipelines = request.session.get(SessionAttributes.USER_PIPELINES.value)
    ...
    async def get_jenkins_pipeline_builds(self, request: Request, pipeline_id) -> JSONResponse:
        await self._validate_user_access(request, pipeline_id)
    ...
    async def get_jenkins_pipeline_build(self, request: Request, pipeline_id: int, build_id: int) -> JSONResponse:
        await self._validate_user_access(request, pipeline_id)
    ...
    async def run_new_jenkins_pipeline_build(self, request: Request,
                                             pipeline_id: int, params: JenkinsStartPipelineParams) -> JSONResponse:
        await self._validate_user_access(request, pipeline_id)
    ...
    async def cancel_jenkins_pipeline_build(self, request: Request, pipeline_id: int, build_id: int) -> JSONResponse:
        await self._validate_user_access(request, pipeline_id)
    ...
    async def get_jenkins_pipeline_params(self, request: Request, pipeline_id: int) -> JSONResponse:
        await self._validate_user_access(request, pipeline_id)
